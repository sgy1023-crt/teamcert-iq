      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="flex flex-wrap items-center gap-3 mb-6">
            ...
            {/* LLM status badge — shown when Manager Insight used a real model */}
            {result.managerInsights.generationMode === "llm" && result.managerInsights.llmProvider && (
              <span
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold border"
                style={{
                  background: "oklch(94% 0.04 160)",
                  borderColor: "oklch(70% 0.12 160)",
                  color: "oklch(38% 0.14 160)",
                }}
                title={`Manager coaching narrative generated by ${result.managerInsights.llmProvider}${result.managerInsights.llmModel ? ` / ${result.managerInsights.llmModel}` : ""}`}
              >
                <span className="text-sm">✨</span>
                <span>
                  Powered by {result.managerInsights.llmProvider}
                  {result.managerInsights.llmModel && result.managerInsights.llmModel !== result.managerInsights.llmProvider && (
                    <span className="opacity-75"> / {result.managerInsights.llmModel}</span>
                  )}
                </span>
              </span>
            )}
